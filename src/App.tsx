        ...
        <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <Field label="Your Name" error={errors.username}>
              <div className="relative">
                <span className={iconWrapper}>
                  <svg width="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="w-5 h-5"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                </span>
                <input
                  id="username"
            ...
            <Field label="Email" error={errors.email}>
              <div className="relative">
                <span className={iconWrapper}>
                  <svg width="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="w-5 h-5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                </span>
                <input
                  id="email"
                  type="email"
            ...
            <Field label="Password" error={errors.password}>
              <div className="relative">
                <span className={iconWrapper}>
                  <svg width="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="w-5 h-5"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                </span>
                <input
                  id="password"
                  type="password"
